<div class="card mb-3">
    <div class="card-body">
        ...
        <h6 class="card-subtitle mb-2 text-muted">by {{ $user->name }} on {{ $entry->created_at->format('d-m-Y') }}</h6>
        ...
        <a href="{{ route('deletePost', ['id' => $entry->id]) }}"><button type="button" class="btn btn-outline-danger">
