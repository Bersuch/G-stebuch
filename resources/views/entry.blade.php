<div class="card mb-3">
    <div class="card-body">
        ...
        <h6 class="card-subtitle mb-2 text-muted">von: <a href="{{ route('profile', ['id' => $entry->user_id]) }}">{{ $entry->name }}</a>, schrieb am: {{ Carbon\Carbon::parse($entry->created_at)->format('d.m.Y') }}, um: {{ Carbon\Carbon::parse($entry->created_at)->format('m:h') }} Uhr</h6>
        ...
        @if($entry->user_id === $user->id)
            ...
            <a href="{{ route('deletePost', ['id' => $entry->id]) }}">
                ...
                <!-- as Admin you can edit all posts -->
